...
$sql211= "SELECT SUM(usd) as total_value FROM btc AND type = 'Withdrawal' WHERE email= '$email' and status= 'approved'";
...
<!doctype html>
            <html lang="en">
                <head>
                    ...
                    <title>User Profile Mycoinscape</title>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card card-user" style="padding: 10px;">
                                                        ...
                                                        <b style="font-size: 25px;">$<?php echo round($ubalance,2);?></b>
                                                        <hr>
                                                        <h6>Total earnings</h6>
                                                        <b style="font-size: 25px;">$<?php echo round($uprofit,2);?></b>
                                                        <hr>
