                                               ...
                                               <input type="hidden" value="<?php echo $pname;?>" name="pname" />
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="double" id="usd" name="amount" placeholder="Amount in USD" class="form-control" required>
                                                                   
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="form-group">
        <button type="submit" name="submit" class="btn btn-info btn-fill pull-right">Proceed</button>
                                                                </div>
                                                            </div>
